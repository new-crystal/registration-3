                    ...
                    <div class="panel-body">
                        <div class="detail_table">
                            <table>
                                ...
                                <tr>
                                    <th>국적구분<br>(수정불가)</th>
                                    <td> <input class="form-control" type="text" value="<?php echo $contry;  ?>"
                                            name="contry" id="contry" disabled></td>
                                </tr>
                                <tr>
                                    <th>등록시간</th>
                                ...
                                <tr>
                                    ...
                                    <td> <input class="form-control onsite_reg" type="text"
                                            ...
                                            id="onsite_reg">
                                        <!-- <select class="onsite_reg_select">
                                ...
                                <tr>
                                    ...
                                    <td> <input type="text" class="form-control memeber_status"
                                            ...
                                            id="ln">
                                        <!-- <select class="memeber_status_select">
                                            <option value="" selected="selected">직접입력</option>
                                            <option value="Non-Member">Non-Member</option>
                                            <option value="Member ( ID : kesId입력 )"> Member ( ID : kesId입력 )</option>
                                        </select> -->
                                    ...
                                    <td>
                                        ...
                                        <div style="display: flex; align-items: center;"><span>
                                            ...
                                            <input class="form-control" type="text"
                                                ...
                                                name="fullname" id="nick_name" disabled>
                                        </div>
                                        <div style="display: flex; align-items: center;">
                                            <p>성함(국문):</p> <input class="form-control" type="text" style="width:230px"
                                                value="<?php echo $item['name_kor']; ?>" name="name_kor" id="nick_name">
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td> <input class="form-control" type="text" value="<?php echo $type1; ?>"
                                            name="type1" id="type1" disabled></td>
                                </tr>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><input class="form-control" type="text" name="remark"
                                            value="<?php echo $remark3; ?>" id="remark3" disabled>
                                    </td>
                                </tr>
                                <tr>
...
memeber_status_select.addEventListener("change", () => {
    memeber_status.value = memeber_status_select.options[memeber_status_select.selectedIndex].value
})
</script>
