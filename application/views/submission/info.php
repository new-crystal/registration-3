    ...
    <div id="container"  class="main"  >
        <div class="contents">
            <h2 class="subTit exin">포스터 접수 안내</h2>

            <div class="txtCon" style="min-height:500px;">
                <div class="txtCon regist">

                    <ul class="conMenu">
                        <li class="on"><a href="/submission/info/">포스터 접수 안내</a></li>
                                ...
                                <fieldset>
                                    ...
                                    <div class="registSearch bdArea">
                                        <dl class="registInfo bdArea" id="infoAbstract">
                                            ...
                                            <dd>
                                                <ul class="listBl">
                                                    <li class="list-middot">초록접수기간 :2023년 2월 13일 (월) <span class="fcRed fwBold"> ~ 2023년 3월 13일(월)까지 </span></li>
                                            ...
                                            <dd>
                                                <ul class="listBl">
                                                    <li class="list-middot">심사결과 통보 : <span class="fcRed fwBold">2023년 3월 13일(월) 예정</span>
                                            ...
                                            <dd>
                                                <ul class="listBl">
                                                    ...
                                                    <li class="list-middot">포스터 파일 접수 마감일: 2023년 3월 17일(금)</li>
