...
<div id="container"  class="main"  >
            ...
            <div class="txtCon regist">
                ...
                <div class="bdArea">
                    <div class="formAbstract">
                        <dl>
                            <h3 class="subTit2" style="text-align: center;">- 포스터 세션 초록 접수 -</h3>
                        </dl>
                        
                        <?php
                            $timestamp = strtotime("Now");
                            if (date("Y-m-d", $timestamp) <= "2023-07-14") {
                        ?>

                        <?php echo form_open('/submission', 'id="submissionForm" name="submissionForm" enctype="multipart/form-data" autocomplete="off"') ?>
                            ...
                            <div class="abstract-container-form bottom-space">
                                ...
                                <div class="abstract-form-content">
                                <input type="text" class="absolute-input-size" id="title" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="abstract-container-form" style="padding:5px;">
                                <div class="abstract-form-title">
                                </div>
                            ...
                            <div class="author-form-group">
                                <fieldset class="author-form">
                                    <div class="abstract-container-form bottom-space">
                                        ...
                                        <div class="abstract-form-content">
                                            <textarea class="absolute-input-size" id="authorNames" name="authorNames"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="abstract-container-form bottom-space">
                                        ...
                                        <div class="abstract-form-content">
                                            <textarea class="absolute-input-size" id="authorAffiliations" name="authorAffiliations"></textarea>
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="author-form-group">
                                <fieldset class="Presenter-form">
                                    <div class="abstract-container-form bottom-space">
                                        ...
                                        <div class="abstract-form-content">
                                            <input type="text" class="absolute-input-size" id="presenterName" name="presenterName" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div class="abstract-container-form bottom-space">
                                        ...
                                        <div class="abstract-form-content">
                                            <input type="text" class="absolute-input-size" id="presenterPhone" name="presenterPhone" autocomplete="off" Placeholder="-제외한 번호를 입력해 주세요" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="abstract-container-form bottom-space">
                                        ...
                                        <div class="abstract-form-content">
                                            <input type="text" class="absolute-input-size" id="presenterMail" name="presenterMail" autocomplete="off" >
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="btn btnArr btnSubm">
                                ...
                                <div class="btnAbstract" id="preview"><b>미리보기</b></div>
                            </div>                                        
                            <?php
                                }else {
                            ?>
    ...
    $(function(){
        ...
        $(document).keyup(function(e) {
            ...
            //console.log(background.getText());
        ...
        $("#preview").on("click", function(){
           ...
           // console.log(formData.get("presentType"));
           ...
           // var modalcontents = s1+s2+s3+s4+s5+s6+s7+s8+s9+s10+images;
            $(".s0").html(s0);
            $(".s1").html(s1);
            $(".s2").html(s2);
            $(".s3").html(s3);
