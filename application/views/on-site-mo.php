    ...
    <div>
        ...
        <table class="tbl_type01">
                ...
                <td>
                    <div class="w-11/12 flex flex-col">
                        <div class="w-full justify-between  mb-3">
                            <input type="text" id="firstName" name="first_name" placeholder="First Name (ex. Gildong) " class="w-full" disabled />
                            <input type="text" id="lastName" placeholder="Last name (ex. Hong) " id="lastName" name="last_name" type="text" class="w-full" disabled />
                        </div>
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="affiliation" name="affiliation" class="w-11/12  mb-3" placeholder="Affiliation (ex. Korea Hospital) " disabled />
                    <input type="text" id="affiliation_kor" name="affiliation_kor" class="w-11/12" placeholder="국문 소속 (ex. 한국대병원)" disabled />
                </td>
            </tr>
            <tr>
                <th>
            ...
            <tr>
                ...
                <td>
                    <div class="flex w-11/12">
                        <input type="text" id="contryNum" name="phone1" class="w-2/6" placeholder="contry number" value="82" />
                        <input type="text" id="phoneNumber" name="phone2" class="w-4/6" placeholder="ex)01012345678" disabled />
                    </div>
                </td>
            </tr>
        ...
        <table class="survey">
            ...
            <tr>
                ...
                <td>
                    <div class="flex w-11/12 justify-between items-center">
                        <select id="Category_1" style="background-color:#ffffff;" class="px-2 py-1 w-full h-10 border" name="member_type">
                            <option value="" selected="selected">Select</option>
