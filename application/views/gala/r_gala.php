    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Gala Dinner R table 참석자 등록확인 페이지</span></h4>
            </div>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Gala Dinner R table 참석자(<?php echo count($users); ?>)</h5>
            </div>
