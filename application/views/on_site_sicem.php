        ...
        <table class="tbl_type01">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input style="display: none;" type="text" id="affiliation_kor" name="affiliation_kor" class="w-11/12" placeholder="국문 소속 (ex. 한국대학교, 한국대병원)" disabled />
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    ...
                    <input style="display: none;" type="text" id="department_kor" name="department_kor" class="w-11/12  mb-3" placeholder="부서" disabled />
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <div class="flex w-11/12 justify-between items-center">
                        <select id="Participation_1" style="background-color:#ffffff;" class="px-2 py-1 w-full h-10 border" name="attendance_type">
                            ...
                            <input type="text" id="participation_others" name="attendance_other_type" style="display: none;width:140%;" placeholder="please write type of Participation" />
                ...
                <td>
                    <div class="flex w-11/12 justify-between items-center border">
                        <select id="Category_1" style="background-color:#ffffff;" class="px-2 py-1 w-full h-10" name="member_type">
                            ...
                            <input type="text" id="category_others" name="member_other_type" style="display: none;width:140%;" placeholder="please write category" />
                        </select>
                    </div>
                </td>
            </tr>
