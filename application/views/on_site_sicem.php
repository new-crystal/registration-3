                ...
                <td>
                    <div class="w-11/12 flex flex-col">
                        <div class="flex w-full justify-between  mb-3">
                            <input type="text" id="firstName" name="first_name" placeholder="First name (only English)" class="w-6/12" disabled />
                            <input type="text" id="lastName" placeholder="Last name (only English)" id="lastName" name="last_name" type="text" class="w-6/12" disabled />
                        </div>
                        <input id="koreanName" name="name_kor" id="koreanName" placeholder="국문 이름 (korean Name)" type="text" class="w-full" disabled>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" id="affiliation" name="affiliation" class="w-11/12  mb-3" placeholder="Affiliation (only English)" disabled />
                    <input type="text" id="affiliation_kor" name="affiliation_kor" class="w-11/12" placeholder="국문 소속 (korean Affiliation)" disabled />
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <div class="flex w-11/12">
                        ...
                        <input type="text" id="phoneNumber" name="phone2" class="w-5/6" placeholder="ex)1012345678" disabled />
                    </div>
                </td>
            </tr>
                ...
                <td>
                    ...
                    <div class="flex items-center w-12/12 justify-left flex-wrap">
                        <div class="flex items-center ">
                            ...
                            <input name="licence_number" id="doctor" type="text" class="mx-2" placeholder="의사 면허 번호" disabled />
                        </div>
                        <div class="flex items-center">
                            <p class="mx-4 number"> 전문의번호 </p>
                            <input name="specialty_number" id="specialist" class="mx-2" type="text" placeholder="전문의 번호" disabled />
                        </div>
                    </div>
                </td>
            </tr>
