            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="sign_up_btn_box" style="display: none;">
                        <br>
                        <a target="_blank" href="https://www.endocrinology.or.kr/member/info.php"><button type="button" class="sign_up bg-blue-300 hover:bg-blue-100">KES 회원가입 (Korean only)</button></a>
                        <a target="_blank" href="https://docs.google.com/forms/d/e/1FAIpQLSeST6AvFwdi3EvAyudol6PeD7evWTcNEH7oh-weHNGORk2izg/viewform"><button type="button" class="sign_up bg-blue-300 hover:bg-blue-100">KES Sign up (For
                                foreigner)</button></a>
                    </div>
                    <div class="kes_id" style="display: none;">
                        <input name="kes_id" class="kes_id_input border p-2 mt-4" placeholder="KES ID를 입력해주세요" />
                    </div>
                </td>
            </tr>
            <tr>
