...
<div class="wrap_1">
    <div class="flex justify-center items-center w-8/12 h-12 mx-auto mt-5 text-4xl sm:text-3xl font-semibold">
                ...
                <td>
                    <div class="w-11/12 flex flex-col">
                        <div class="flex w-full justify-between  mb-3">
                            <input type="text" id="firstName" name="first_name" placeholder="First name (only English)" class="w-6/12" />
                            <input type="text" id="lastName" placeholder="Last name (only English)" id="lastName" name="last_name" type="text" class="w-6/12" />
                        </div>
                        <input id="koreanName" name="name_kor" id="koreanName" placeholder="국문 이름 (korean Name)" type="text" class="w-full">
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" id="affiliation" name="affiliation" class="w-11/12  mb-3" placeholder="Affiliation (only English)" />
                    <input type="text" id="affiliation_kor" name="affiliation_kor" class="w-11/12" placeholder="국문 소속 (korean Affiliation)" />
                </td>
            </tr>
            <tr>
                <th>
