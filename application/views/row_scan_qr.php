...
<body id="body" class="flex items-center justify-center">
    <div id="container" class="w-full h-full flex items-center overflow-hidden">
        ...
        <div class="h-full">
            <div>
                <div>
                    <img src="../../assets/images/row_app_loading_bg.png" onclick="window.location.replace()"
                                ...
                                <div style=" transform: translateY(700px);">
                                    <dl class="pl-2" style="transform: translateY(-200px);">
                                        <dd><input type="text" name="qrcode" id="qrcode"
                                                ...
                                                style="    transform: translate(74px,-20px);width: 800px;"
                                    ...
                                    <dl class="pl-2" style="transform: translateY(-200px);">
                                        <div id="qr_entrance" class="qr_info_wrap">
                                            <div class="info_content">
                                                <input type="text"
                                                    style="margin-top:3px;transform: translate(857px, -226px);"
                                                    class="qr_info input" value="<?php if (isset($enter)) {
                                        ...
                                        <div id="qr_exit" class="qr_info_wrap">
                                            <div class="info_content">
                                                <input type="text"
                                                    style="margin-top:0; transform: translate(854px, -107px);"
                                                    class="qr_info input" value="<?php if (isset($leave)) {
