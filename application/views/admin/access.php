                ...
                <form action="/admin/access" id="qr_form" name="qr_form"
                    ...
                    <div class="w-full bg-white flex items-left justify-around" style="margin-top:3rem;">
                        ...
                        <table class="qr-info-table mb-80 w-2/5" id="qrTable">
                            ...
                            <tr>
                                <th class="memoHeader">첫번째 참석 여부</th>
                                <td id="first_time_yn" class="qr_text">
                                    <?php if (isset($user['first_time_yn'])) echo $user['first_time_yn'] ?>
                                </td>
                            </tr>
                            <tr>
                                <th class="memoHeader">Remark 1<br>(구분택 내용)</th>
                                <td id="remark1" class="qr_text">
                                    <?php if (isset($user['remark1'])) echo $user['remark1'] ?>
                                </td>
                            </tr>
                            <tr>
                                <th class="memoHeader">Remark 2<br>(Gala Dinner)</th>
...
const remark6 = document.querySelector("#attendance_date")
const remark7 = document.querySelector("#first_time_yn")
    ...
    fetch(`/admin/access?qrcode=${qrcode}`)
        ...
        .then(data => {
            ...
            if (htmlDocument.querySelector("#number").innerText) {
                ...
                remark5.innerText = htmlDocument.querySelector("#remark5").innerText.replace(/<br\s*\/?>/gi, "")
                    .trim();
                remark6.innerText = htmlDocument.querySelector("#attendance_date").innerText.replace(/<br\s*\/?>/gi,
                        "")
                    .trim();
                remark7.innerText = htmlDocument.querySelector("#first_time_yn").innerText.replace(/<br\s*\/?>/gi,
                        "")
                    .trim();
