                    ...
                    <div class="panel-body">
                            ...
                            <table>
                                <tr>
                                    <td colspan="2"><button type="button" class="btn btn-primary"
                                            onclick="print('<?php echo $item['registration_no']; ?>')">QR Print</button>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td> <input id="dp1" type="text" value="<?php echo $item['day2_breakfast_yn']; ?>"
                                            size="16" class="form-control yn" name="day2_breakfast_yn">
                                ...
                                <tr>
                                    ...
                                    <td> <input id="dp1" type="text" value="<?php echo $item['day2_luncheon_yn']; ?>"
                                            size="16" class="form-control yn" name="day2_luncheon_yn">
                                ...
                                <tr>
                                    ...
                                    <td> <input id="dp1" type="text" value="<?php echo $item['day3_breakfast_yn']; ?>"
                                            size="16" class="form-control yn" name="day3_breakfast_yn">
                                ...
                                <tr>
                                    ...
                                    <td> <input id="dp1" type="text" value="<?php echo $item['day3_luncheon_yn']; ?>"
                                            size="16" class="form-control yn" name="day3_luncheon_yn">
                        ...
                        <div class="detail_table">
                            <table>
                                ...
                                <tr>
                                    <th>qr print 여부</th>
                                    <td><input class="form-control yn" type="text"
                                            value="<?php echo $item['qr_print']; ?>" name="qr_print" id="phone"></td>
                                </tr>
                                <tr>
                                    <th>day 1 출결여부</th>
                                    <td><input class="form-control yn" type="text"
                                ...
                                <tr>
                                    ...
                                    <td> <input type="text" class="form-control"
                                            value="<?php echo $item['deposit_method']; ?>" name="deposit_method"
                                            id="etc4"></td>
                                </tr>
                        ...
                        <div clss="btn_group" style="float: right;">
                            ...
                            <button type="button" class="btn btn-danger"
                                onclick="removeUser('<?php echo $item['registration_no']; ?>')">삭제</button>
