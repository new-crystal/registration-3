                    ...
                    <div class="panel-body">
                        <div class="detail_table">
                            <table>
                                ...
                                <tr>
                                    <th>국내/국외</th>
                                    <td> <input class="form-control" type="text" name="contry" id="type2" value="<?php echo $contry ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div style="display: flex; align-items: center;"><span> fullname:</span> <input class="form-control" type="text" value="<?php echo $item['first_name'] . " " . $item['last_name']; ?>" name="fullname" id="nick_name"></div>
                                        <input class="form-control" type="text" value="<?php echo $item['name_kor']; ?>" name="name_kor" id="nick_name">
                                    </td>
                                </tr>
                                <tr>
                                    <th>소속</th>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($item['member_type'] == "Student") { ?>
                                            <input class="form-control" type="text" style="color: red;" value="<?php echo $item['member_type']; ?>" name="member_type" id="type1">
                                        <?php  } else { ?>
                                ...
                                <tr>
                                    <th>등록비</th>
                                    <td><input class="form-control" type="text" value="<?php echo $item['fee']; ?>" name="fee" id="fee">
                                    </td>
                                </tr>
                                <tr>
                                    <th>결제일</th>
                                ...
                                <tr>
                                    <th>결제방식</th>
                                    <td> <input type="text" class="form-control" name="etc1" id="ln" value="<?php echo $item['etc1']; ?>"></td>
                                </tr>
                                <tr>
                                    <th>결제금액
