                    ...
                    <div class="panel-body">
                        <div class="detail_table">
                            <table>
                                ...
                                <tr>
                                    <th>국적구분<br>(수정불가)</th>
                                    <td> <input class="form-control" style="background-color:#fafafa;" type="text" value="<?php echo $contry;  ?>" name="contry" id="contry" disabled></td>
                                </tr>
                                <tr>
                                    <th>등록시간</th>
                                ...
                                <tr>
                                    ...
                                    <td> <input class="form-control onsite_reg" type="text" value="<?php echo $item['onsite_reg'];  ?>" name="onsite_reg" id="onsite_reg">
                                ...
                                <tr>
                                    ...
                                    <td> <input class="form-control" type="text" value="<?php echo $date; ?>" name="date" id="date" style="background-color:#fafafa;" disabled></td>
                                </tr>
                                <tr>
                                    <th>KES Membership Check-up</th>
                                    <td> <input type="text" class="form-control memeber_status" value="<?php echo  $item['kes_member_status']; ?>" name="kes_member_status" id="ln">
                                        <select class="memeber_status_select input-lg m-bot15">
                                            <option value="" selected="selected">직접입력</option>
                                            <option value="Non-Member">Non-Member</option>
                                            <option value="Member"> Member ( ID : kesId 필수입력 )</option>
                                        </select>
                                        <input class="kes_id" placeholder="KES ID를 적어주세요" style="padding:4px; display:none" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>국가</th>
                                ...
                                <tr>
                                    <th>참석자구분2</th>
                                    <td><input class="form-control member_other_type" type="text" value="<?php echo $item['member_other_type']; ?>" name="member_other_type" id="type1">
                                ...
                                <tr>
                                    <th>참석날짜(수정용)</th>
                                    <td> <input class="form-control attendance_date" type="text" value="<?php echo $item['attendance_date']; ?>" name="attendance_date" id="date">
